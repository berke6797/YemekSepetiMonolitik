...
@Repository
public interface IOrderCustomerRepo extends JpaRepository<OrderCustomer,Long> {
    @Query(nativeQuery = true, value =
            "select o.order_id,c.customer_id,c.customer_name,c.customer_surname,c.customer_address,p.product_name,p.cost,r.restaurant_name from tbl_order as o \n" +
    ...
    List<OrderCustomer> musteriyeOzelSiparisleriListele(Long customerId);
